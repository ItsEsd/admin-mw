...
$(document).ready(function () {
  ...
  applyBtn.addEventListener("click", function () {
    ...
    document.getElementById("alllog").innerHTML =
      '<iframe src="/ap/fetchlogAll.html" ></iframe><span id="closeactn">Close</span>';

    $("#closeactn").click(function () {
      $("#rffrlfrm").hide();
      $("#alllog").empty();
      document.getElementById("alllog").innerHTML =
        '<center style="margin-top:200px;">Loading...</center><span id="closeactn">Close</span>';
    });
  });
});
